cordova.define("yandex-appmetrica-plugin-cordova.appmetrica", function (require, exports, module) {
    ...
    module.exports = {
        ...
        showProductCard: function (params) {
            appMetricaExec('showProductCard', [params])
        },
        addToCart: function (params) {
            appMetricaExec('addToCart', [params]);
        },
        removeFromCart: function (params) {
            appMetricaExec('removeFromCart', [params]);
        },
        beginCheckout: function (params) {
        ...
        finishCheckout: function (params) {
            cordova.exec(function (e) {
                console.log(e);
            }, function (e) {
                console.warn(e)
        ...
        showScreen: function (params) {
            appMetricaExec('showScreen', [params]);
        },
        /**
